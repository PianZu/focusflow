      ...
      >
        <nav style={{ padding: "1rem", borderBottom: "1px solid #eee", marginBottom: "1rem", backgroundColor: "#f8f9fa" }}>
          <ul style={{ listStyle: "none", display: "flex", justifyContent: "center", gap: "2rem", margin: 0, padding: 0 }}>
            <li>
              <Link href="/tasks" style={{ textDecoration: "none", color: "#007bff", fontWeight: "bold" }}>
                Tasks
              </Link>
            </li>
            <li>
              <Link href="/teams" style={{ textDecoration: "none", color: "#007bff", fontWeight: "bold" }}>
                Teams
              </Link>
            </li>
            {/* Optional: Link zur Hauptseite/Login-Seite, falls gewünscht */}
            <li>
              <Link href="/" style={{ textDecoration: "none", color: "#6c757d", fontWeight: "normal" }}>
                Login/Home
              </Link>
            </li>
